...
public:
    ...
    struct AP_Motors_limit {
        ...
        uint16_t motor_lower     : AP_MOTORS_MAX_NUM_MOTORS; // a certain motor has reached the lower warning threshold
        uint16_t motor_upper     : AP_MOTORS_MAX_NUM_MOTORS; // a certain motor has reached the upper warning threshold
    } limit;
